...
void Application::Display(void)
{
	...
	glm::quat q1X = glm::angleAxis(m_v3Rotation.x, vector3(1.0f, 0.0f, 0.0f));
	glm::quat q1Y = glm::angleAxis(m_v3Rotation.y, vector3(0.0f, 1.0f, 0.0f));
	glm::quat q1Z = glm::angleAxis(m_v3Rotation.z, vector3(0.0f, 0.0f, 1.0f));
	//glm::quat q1W = glm::angleAxis(45.0f, vector3(1.0f, 0.0f, 0.0f));
